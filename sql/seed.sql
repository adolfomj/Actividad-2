...
-- Se crean dos docentes con call "procedimiento almacenado"
-- Docentes (CREATE)
...
/*
Con set le asignamos un valor a una variable, 
por ejemplo, busca en la tabla el numero_documento "cc1001" y extrae el id que relaciona ese documento del docente
y lo guarda en @id_ana
 */ 
...
-- creamos dos proyectos más con el id de ana y carlos
-- Proyectos (CREATE)
...
-- actualizamos los datos de carlos
...
('Actualización Curricular de Ingeniería 01','Revisión y modernización de sílabos con enfoque por competencias','2023-01-15',NULL,28000.00,120,2),
('Laboratorio de Robótica Educativa 02','Implementación de kits y guías para prácticas en robótica móvil','2023-01-29','2023-09-10',32000.00,140,9),
('Semillero de Investigación en IA 03','Formación de estudiantes en proyectos de IA aplicada a la educación','2023-02-12',NULL,36000.00,160,10),
('Acreditación de Programa 04','Preparación de evidencias e informes para acreditación nacional','2023-02-26','2023-11-20',41000.00,180,11),
('Talleres de Pensamiento Computacional 05','Ciclo de talleres para escuela y pregrado con evaluación de impacto','2023-03-12',NULL,45000.00,150,12),
('Repositorio de Recursos Abiertos 06','Diseño de un OER institucional con licencias abiertas','2023-03-26','2023-10-30',38000.00,140,13),
('Clínica de Datos 07','Acompañamiento metodológico a proyectos de investigación estudiantil','2023-04-09',NULL,52000.00,200,14),
('Evaluación de Aprendizajes 08','Diseño de rúbricas y bancos de ítems para cursos troncales','2023-04-23','2023-12-05',33000.00,120,15),
('Diplomado en Analítica Educativa 09','Programa de extensión con enfoque en tablero de indicadores','2023-05-07',NULL,59000.00,220,16),
('Vinculación con el Medio 10','Alianzas con colegios para proyectos de aula con tutorías','2023-05-21','2023-12-15',30000.00,110,17),
('Centro de Escritura Académica 11','Creación de tutorías y materiales para redactar artículos científicos','2023-06-04',NULL,64000.00,230,18),
('Aula Híbrida Piloto 12','Implementación de tecnologías para enseñanza síncrona/asincrónica','2023-06-18','2024-01-20',70000.00,260,19),
('Club de Ciberseguridad 13','Formación extracurricular con retos de captura la bandera','2023-07-02',NULL,42000.00,160,20),
('MOOC de Introducción a la Programación 14','Producción de curso masivo abierto con evaluación automática','2023-07-16','2024-02-15',88000.00,300,21),
('Biblioteca de Casos 15','Colección de estudios de caso locales para cursos de proyectos','2023-07-30',NULL,41000.00,150,22),
('Observatorio de Empleabilidad 16','Levantamiento y análisis de datos de egresados','2023-08-13','2024-03-01',62000.00,210,23),
('Seminario Permanente de Investigación 17','Ciclo de charlas con investigadores invitados','2023-08-27',NULL,35000.00,140,24),
('Certificación Docente Interna 18','Ruta de microcredenciales para docencia universitaria','2023-09-10','2024-03-20',54000.00,190,25),
('Feria de Proyectos Integradores 19','Evento anual de exposición y evaluación por pares','2023-09-24',NULL,37000.00,130,26),
('Rediseño de Laboratorios de Redes 20','Actualización de equipos y guías de prácticas','2023-10-08','2024-04-18',96000.00,320,27);
...
-- Aqui separé esta linea porque me generaba error ya que los ids de docente estan repetidos
